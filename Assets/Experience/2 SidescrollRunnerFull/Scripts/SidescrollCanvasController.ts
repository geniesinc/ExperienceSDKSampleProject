...
export default class SidescrollCanvasController extends MonoBehaviour {
    ...
    @SerializeField private personalBestScoreText: TMP_Text;
    ...
    private OnGameOver() {
        ...
        this.CheckHighScore(this.personalStorage, this.personalBestScoreText, this.personalString);
    ...
    private InitializeHighScores() {
        ...
        this.LoadHighScore(this.personalStorage, this.personalBestScoreText, this.personalString);
